...
Dentre as provas que os competidores têm que passar incluem-se carregar pedras super pesadas, puxaar caminhões ou ônibus, jogar objetos gigantes, etc. Cada prova tem uma pontuação, e o competidor que fizer mais pontos é o vencedor.
...
Para isso, faça um programa que leia o nome e 4 notas de cada competidor, e armazene estes dados em um vetor de structs. Depois, desenvolva uma função que receba este vetor e retorne a posição do vetor em que está o vencedor da competição. Você pode considerar que não haverá empates.
